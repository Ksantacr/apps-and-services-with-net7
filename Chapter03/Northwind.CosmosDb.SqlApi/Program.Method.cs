...
partial class Program
{
    ...
    private static string account = "apps-services-net7-cosmosdb"; // use your account
    private static string endpointUri = $"https://{account}.documents.azure.com:443/";
    private static string primaryKey = "GjDYcZt1GwFhTcC5RxbM5Bhgkz0WaNnLKHSESXbBB7OYszQzW40CGbs7Uy9ztwblTmWjLOgWcvuqACDbvIDbbw=="; // use your key
    ...
    static async Task CreateCosmosResources()
    {
     ...
     .CreateDatabaseIfNotExistsAsync("Northwind", throughput: 100 /* RU/s */);
